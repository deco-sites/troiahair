    ...
    return (<div id="it-works" class="container py-10 flex flex-col h-screen w-full items-center justify-center gap-16">
      ...
      <div class="flex flex-col items-center justify-center gap-2">
        <div class="flex items-center gap-4">
          <button hx-target="#it-works" hx-swap="outerHTML" hx-get={downLink["f-partial"]} // htmx link for this section with the down vote props
     class="btn btn-sm btn-circle btn-outline no-animation">
          ...
          <span>{count}</span>
          <button hx-target="#it-works" hx-swap="outerHTML" hx-get={upLink["f-partial"]} // htmx link for this section with the up vote props
     class="btn btn-sm btn-circle btn-outline no-animation">
            <span class="inline [.htmx-request_&]:hidden">
              +
            </span>
